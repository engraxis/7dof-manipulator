...
% Dated:  Nov 5, 2018
%
% <<<   Enter T_7_0 & psi as the input parameter     >>>

function angles_ik_deg = ik_SRS(T_7_0, psi)
...
R_3_0 = R_psi * R_3_0_dash;             %(4.7)      %(4.19), (4.7) Both generates same result
...
angles_ik_deg = rad2deg([theta1_ik theta2_ik theta3_ik theta4_ik theta5_ik theta6_ik theta7_ik]);